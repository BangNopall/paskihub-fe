...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn("rounded-full bg-primary-200 shadow-sm", activeClassName)}
      value={activeValue}
      transition={transition}
    >
      <div
        ...
        data-slot="tabs-list"
        className={cn(
          "inline-flex h-10 w-fit items-center justify-center rounded-lg bg-white p-1 text-muted-foreground",
          className
        )}
        {...props}
      >
