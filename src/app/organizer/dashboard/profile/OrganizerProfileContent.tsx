      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 p-4 md:gap-8 md:p-6 lg:p-8">
        ...
        <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
          <DialogContent className="w-full max-w-md gap-0 rounded-3xl p-0 sm:rounded-[32px]">
            <form
              onSubmit={staffCreateForm.handleSubmit(onAddStaffSubmit)}
              ...
              <div className="flex flex-col gap-6 p-6 sm:p-10">
                <div className="flex flex-col gap-2">
                  ...
                  <Input
                    ...
                    className={cn(
                      "h-12 bg-white font-poppins text-sm focus-visible:ring-sky-200",
                      staffCreateForm.formState.errors.email && "border-red-500"
                    )}
                  />
                  {staffCreateForm.formState.errors.email && (
                    <p className="font-poppins text-xs text-red-500">
                      {staffCreateForm.formState.errors.email.message}
                    </p>
                  )}
                </div>
                <div className="flex flex-col gap-2">
                  <Label
                    htmlFor="password_create"
                    className="font-poppins text-sm text-neutral-600"
                  >
                    Password Sementara
                  </Label>
                  <Controller
                    ...
                    render={({ field }) => (
                      <PasswordInput
                        ...
                        error={
                          staffCreateForm.formState.errors.password?.message
                        }
                      />
                    )}
                  />
                ...
                <div className="flex flex-col gap-2">
                  <Label
                    htmlFor="confirm_password_create"
                    className="font-poppins text-sm text-neutral-600"
                  >
                    Konfirmasi Password
                  </Label>
                  <Controller
                    ...
                    render={({ field }) => (
                      <PasswordInput
                        ...
                        error={
                          staffCreateForm.formState.errors.confirm_password
                            ?.message
                        }
                      />
                    )}
        ...
        <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
          <DialogContent className="w-full max-w-md gap-0 rounded-3xl p-0 sm:rounded-[32px]">
            <form
              onSubmit={staffResetPwdForm.handleSubmit(onResetStaffPwdSubmit)}
              className="flex flex-col"
            >
              <DialogHeader className="p-6 pb-0 sm:px-10 sm:pt-10">
                <DialogTitle className="text-center font-montserrat text-2xl font-bold text-neutral-800">
              ...
              <div className="flex flex-col gap-6 p-6 sm:p-10">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <PasswordInput
                        ...
                        placeholder="Minimal 8 karakter"
                        error={
                          staffResetPwdForm.formState.errors.password?.message
                        }
                      />
                    )}
                  />
                ...
                <div className="flex flex-col gap-2">
                  <Label
                    htmlFor="confirm_password_reset"
                    className="font-poppins text-sm text-neutral-600"
                  >
                    Konfirmasi Password Baru
                  </Label>
                  <Controller
                    ...
                    render={({ field }) => (
                      <PasswordInput
                        ...
                        placeholder="Ketik ulang password"
                        error={
                          staffResetPwdForm.formState.errors.confirm_password
                            ?.message
                        }
                      />
                    )}
