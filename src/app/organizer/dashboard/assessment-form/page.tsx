          ...
          <CardContent className="space-y-6">
            ...
            <InfoSection>
              <div className="relative w-full overflow-hidden rounded-lg">
                ...
                <div className="flex flex-col gap-4 p-1 pb-4 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Label className="text-sm font-medium text-neutral-700 text-center">
                      Kategori
                    </Label>
